exports.middleware = function middleware(limit, maxLimit) {
    ...
    return function _middleware(req, res, next) {
      ...
      req.query.page = (typeof req.query.page === 'string') ? parseInt(req.query.page) || 1 : 1;
  
      req.query.limit = (typeof req.query.limit === 'string') ? parseInt(req.query.limit) || 0 : _limit;
  ...
  exports.getPaginationObject = function getPaginationObject(pagination, count) {
    pagination.count = count;
    console.log(Math.ceil(count / pagination.limit));
